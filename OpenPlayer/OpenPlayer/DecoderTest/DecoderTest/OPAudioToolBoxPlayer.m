...
@interface OPAudioToolBoxPlayer() {
...
@implementation OPAudioToolBoxPlayer
...
static void AudioPlayerAQInputCallback(void* inUserData,AudioQueueRef audioQueueRef, AudioQueueBufferRef audioQueueBufferRef) {
    ...
    OPAudioToolBoxPlayer* player = (__bridge OPAudioToolBoxPlayer*)inUserData;
